...
-- ============================================
-- 7. FAQ Tabelle (für FAQ-Verwaltung)
-- ============================================
CREATE TABLE IF NOT EXISTS faqs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    faq_id VARCHAR(255) NOT NULL, -- Eindeutige FAQ-ID (z.B. "general-1")
    language VARCHAR(2) NOT NULL CHECK (language IN ('de', 'en')), -- Sprache: 'de' oder 'en'
    
    -- FAQ-Inhalte
    category VARCHAR(255) NOT NULL, -- Kategorie (z.B. "Allgemeine Fragen")
    question TEXT NOT NULL,
    answer TEXT NOT NULL,
    
    -- Sortierung
    order_index INTEGER DEFAULT 0, -- Sortierungsindex innerhalb der Kategorie
    ...
    -- Eindeutiger Constraint für FAQ-ID + Sprache Kombination
