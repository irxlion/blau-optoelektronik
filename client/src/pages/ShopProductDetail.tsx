  ...
  const getProductImage = (product: ShopProduct): string => {
    ...
    if (!mapped && isEnglish) {
      ...
      if (typeof window !== "undefined") {
        ...
        const key = `__dbg_shop_detail_img_miss_${product.category || "unknown"}`;
        if (!w[key]) {
          w[key] = true;
          fetch("http://127.0.0.1:7242/ingest/11ad90a2-7433-4ef9-b753-18907f0bce0b", {
            ...
            body: JSON.stringify({
              ...
              runId: "pre-fix",
              hypothesisId: "B",
              location: "ShopProductDetail.tsx:getProductImage",
              message: "ShopProductDetail image map miss (EN) -> fallback",
